...
function interact(t) {
  if (t.player.hasActiveQuest(33)) {
    ...
    if (!npcExists(t, "Carter")) {
      ...
      t.npc.say("You were trying to hire Carter, but she already exists. I removed that quest. If you were tyring to completed a different quest then interact again.");
    }
  }
}
